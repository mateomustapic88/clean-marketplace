...
export default defineEventHandler((event) => {
  ...
  return [
    '# Clean',
    '',
    '> Clean is a Croatian marketplace that connects apartment owners with independent cleaning professionals.',
    '',
    ...
    `- [How Clean works](${siteUrl}/kako-funkcionira)`,
    ...
    '- Clean does not process the payment for the cleaning service or charge commission on it.',
